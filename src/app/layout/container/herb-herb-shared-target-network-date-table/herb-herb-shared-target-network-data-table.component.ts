...
@Component({
  selector: 'app-herb-herb-shared-target-network-data-table',
  templateUrl: './herb-herb-shared-target-network-data-table.component.html',
  styleUrls: ['./herb-herb-shared-target-network-data-table.component.css']
})

export class HerbHerbSharedTargetNetworkDataTableComponent implements OnInit, AfterViewInit {
  ...
  gotoSharedTargets(firstHerbId, secondHerbId) {
